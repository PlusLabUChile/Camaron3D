...
void ConvexGeometryDefinedByPlanes::uploadMainVertexData(){
	...
	for(Plane plane: planes){
		// first triangle
		triangleVertices.push_back(plane.getPointPlaneByIndex(0));
		triangleVertices.push_back(plane.getPointPlaneByIndex(1));
		triangleVertices.push_back(plane.getPointPlaneByIndex(3));

		// second triangle
		triangleVertices.push_back(plane.getPointPlaneByIndex(0));
		triangleVertices.push_back(plane.getPointPlaneByIndex(2));
		triangleVertices.push_back(plane.getPointPlaneByIndex(3));
	}
...
void ConvexGeometryDefinedByPlanes::deletePlanes(){
	planes.clear();
}