...
class MouseSelection: public SelectionStrategy
{
	...
	private:
		...
		bool selectElementAlgorithm( Model*, vis::Element *, int elementType);
		//Select Using CPU
		bool selectCPU( Model*, vis::Polyhedron *);
		bool selectCPU( Model*, vis::Polygon * );
		bool selectCPU( Model*, vis::Vertex *);
		bool selectFBO( vis::Element *, int elementType);
		//Select Using CPU
		bool selectFBO( Model*, vis::Polyhedron *);
		...
		//help
		bool hasFaceFacingCamera(Model*, vis::Polyhedron *p);
		vis::Polygon* getFaceFacingCamera(Model*, vis::Polyhedron *p);
		bool pointInsidePolygon(Model*, vis::Polygon *);
