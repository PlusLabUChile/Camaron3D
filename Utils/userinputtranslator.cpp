...
UserInputTranslator::UserInputTranslator()
{
	...
	ADD_USER_INPUT_DIC_UNIT_2INPUTS("Convex Geometry Intersection","Enter to edit Mode",
							SHOW_DELETE_RENDER,Qt::Key_H,Qt::LeftButton,false,false);

	ADD_USER_INPUT_DIC_UNIT_2INPUTS("Convex Geometry Intersection","Move XY",
							SHOW_DELETE_RENDER,Qt::Key_Q,Qt::LeftButton,false,false);

	ADD_USER_INPUT_DIC_UNIT_2INPUTS("Convex Geometry Intersection","Move ZY",
							SHOW_DELETE_RENDER,Qt::Key_A,Qt::LeftButton,false,false);

	ADD_USER_INPUT_DIC_UNIT_2INPUTS("Convex Geometry Intersection","Move XZ",
							SHOW_DELETE_RENDER,Qt::Key_Z,Qt::LeftButton,false,false);

	ADD_USER_INPUT_DIC_UNIT_2INPUTS("Convex Geometry Intersection","Change size",
							SHOW_DELETE_RENDER,Qt::Key_W,Qt::LeftButton,false,false);
